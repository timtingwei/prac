...
import copy 
startpoint = rs.GetPoint("please pick a point in Rhino")
...
def singlestep(startpoint,directionvector,swingdirection,multi,swingangle,rotateangle,plst,pdplaneorient):
    """海龟爬行循环函数
    """
